...
while ($row = @mysqli_fetch_assoc($result)){
  ...
  echo '<input type="number" min="0" name="'. parseToXML($row['resourceName']) .'" style="float:right;width:20%;margin: -20px 20px 20px 0px;" name="quantity" max="'. parseToXML($row['quantity']) . '">';
